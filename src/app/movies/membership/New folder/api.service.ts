...
`,
 ...
 `,
  ...
  sendBookingData(payload: any): Observable<any> {
    ...
    var newbody = {
      data: this.commonFunction.encryptdata2(payload)
    }
    return this.http.post<any>(
 ...
 `,
  ...
  getmembershipplandata(data: any): Observable<any> {
    var dataaa = {
      filter: data
    }
    const headers = new HttpHeaders({
  ...
  calculatePlanDetails(
    ...
    return this.http.post<any>(
      // `${this.apiUrl}schedulePlayDetails/getCityWisePlays`,
      // `${this.apiUrl}web/getWebNowShowingAndUpcomingEvents`,
      `${this.apiUrl}web/calculatePlanDetails`,
      body,
      {
        headers,
      }
